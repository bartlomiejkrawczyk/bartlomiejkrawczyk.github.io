...
<Figure src={logo} alt="Taskee Logo" width="80%" />

<Figure src={icons} alt="Taskee Icons" width="60%" />
...
<Figure src={colors} alt="Taskee Color Scheme" width="80%" />

<Figure src={visualization} alt="Logo Visualization" width="80%" />
...
<Figure src={email} alt="Email Support" width="60%" />
