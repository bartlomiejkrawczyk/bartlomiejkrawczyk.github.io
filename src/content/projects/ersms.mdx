...
description: |
  A cloud-native, distributed forum platform built with microservices, CQRS, event sourcing, and Kubernetes orchestration. The system features centralized logging, full observability, OAuth2 identity, and automated CI/CD-designed to demonstrate real-world patterns for scalable, fault-tolerant backend systems.
tags:
  - university
  - kotlin
  - sql
...
<Figure src={actions2} alt="Github Actions - Build & Publish" width="80%" />
...
<Figure src={prometheus} alt="Prometheus Dashboard" width="80%" />

<Figure src={grafana} alt="Grafana Dashboard" width="80%" />
...
<Figure src={kibana} alt="Kibana dashboard" width="80%" />
...
<Figure src={grafana_stats} alt="Grafana reliability stats" width="80%" />
