...
<Figure src={mainScreen} alt="Main Screen" width="40%" />
...
<div style="width: 49.3%; display: inline-block; ">
  <Figure src={selectionScreen} alt="Selection Screen" width="80%" />
</div>
<div style="width: 49.3%; display: inline-block; ">
  <Figure
...
<Figure src={passwordGeneration} alt="Password Generation" width="40%" />
